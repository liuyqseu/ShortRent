...
public class UploadServlet extends ActionSupport 
{
	...
	public void poster(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		
		
		System.out.println("yijinru11");
